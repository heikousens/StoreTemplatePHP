...
$sql2 = "SELECT * FROM produto where categoria='Lápis & Lapiseira'"; /* o filtro aqui pode ser qualquer coisa, como preço em vez de categoria */
...
<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
	<div class="page-header" style="margin-left:20px; margin-right:20px; margin-top: 0px; border-bottom: 5px solid rgba(238,180,180, 0.5);">
		<h3 style="font-family: Verdana; margin-left:10px; margin-right:10px; color: #888888; letter-spacing: 2px;">Lápis & Lapiseiras</h3>
	</div>
	<br/>
	<p style="font-family: Verdana; margin-left:40px; margin-right:40px; color: #888888; letter-spacing: 2px;">Os melhores lápis e lapiseiras para você deixar sua criatividade fluir livremente para o papel. Materiais de qualidade e uma variedade de produtos só esperando por você e pelo seu talento!</p>
	<br/>
	<div class="row">
		<!--Imagens diretas do banco-->       
        <?php
        $stmt = $conexao->prepare("SELECT * FROM produto WHERE categoria = 'Lápis & Lapiseira'");
        if ($stmt->execute()) {
